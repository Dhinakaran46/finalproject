...
region = 'ap-southeast-1'  # Change this to the region where you want to create the bucket
s3_client = boto3.client('s3', region_name=region)

# Define the bucket name and object key
bucket_name = 'bucketdkd'
...
try:
    ...
    if region == 'ap-southeast-1':
        # No location constraint needed for ap-southeast-1
    ...
    try:
        ...
        s3_client.upload_file(
            'E:\\python\\index.html', bucket_name, object_key,
